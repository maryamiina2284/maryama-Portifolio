          ...
          <div className="animate__animated animate__fadeInRight">
            ...
            <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
              <p className="text-gray-300 mb-6">
                I'm Eng. Maryama Ahmed Mohamoud, a passionate and
                detail-oriented software developer with a strong foundation in
                web and software development. I ungraduated from Jamhuriya
                University and my mission is to create innovative solutions that
                simplify life and enhance user experiences. 💻 Fullstack
                Developer | Frontend & Backend Projects | CS & IT Student 🚀
                Skilled in HTML, CSS, JavaScript, React, PHP, MySQL, Flask,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
              ...
              <div className="p-6 rounded-2xl border border-white/10 backdrop-blur bg-white/5 shadow-lg transition-all hover:-translate-y-1 hover:shadow-blue-400/30 animate__animated animate__fadeInUp animate__delay-1s">
                ...
                <div className="space-y-2 text-gray-300 text-sm md:text-base">
                  <p>
                    <strong>Email:</strong> maryamiinaruun6@gmail.com
                  </p>
                  <p>
                    <strong>Phone:</strong> +252 616464022
                  </p>
                  <p>
                    <strong>GitHub:</strong>{" "}
                    <a
                      href="https://github.com/maryamiina2284"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-400 hover:underline"
                    >
                      github.com/maryamiina2284
                    </a>
                  </p>
                </div>
              </div>
